...
export default function ColecaoSelector({ value, onChange }: ColecaoSelectorProps) {
  ...
  return (
    <div className="bg-card border border-border rounded p-6 shadow-sm">
      <div className="flex items-center gap-3 mb-4">
        ...
        <label htmlFor="colecao" className="text-base font-semibold text-card-foreground">
          Coleção
        </label>
      </div>
